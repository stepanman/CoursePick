...
namespace MvcSubjectPick.Controllers
{
    public class TutorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Surname,Name,Email,BirthDate,Resume,ImagePath")] Tutor tutor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Surname,Name,Email,BirthDate,Resume,ImagePath")] Tutor tutor)
        {
            if (id != tutor.Id)
            {
                return NotFound();
